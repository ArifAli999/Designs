...
function ChatBox({ chatMessage, setChatMessage, sendMessage }) {
    return (
        <div className='w-full flex flex-row gap-6 items-center absolute bottom-0'>
            <div className='flex-1'>
                ...
                <div class="flex items-center px-3 py-2  bg-gray-50 dark:bg-gray-700">
                    ...
                    <button
                        onClick={() => sendMessage()}
                        type="submit" class="inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 dark:text-blue-500 dark:hover:bg-gray-600">
